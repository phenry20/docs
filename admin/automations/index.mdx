---
title: Configuration
description: Learn how to create and manage automations in KnowKR
icon: 'gear'
---

Automations enable you to reward employees or execute functions (ie. Replenishing boosts) automatically using KnowKR’s AI.
...
KnowKR’s AI executes automations at various time intervals. Some are pre-determined, but some are configurable (e.g. Boost Refresh Automation). If the interval is pre-determined it will have a time value (e.g. 30 MIN means the automation runs every 30 mins). If the interval is configurable it will say Custom.
