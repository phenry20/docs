---
title: Invite Users
description: Learn all about inviting user to Vork.
icon: 'user-plus'
---

<Card title="Please Note" icon="lightbulb" iconType="duotone" color="#ca8b04">
    When you invite users, they will be sent an email invite to Vork. To avoid confusion it’s always suggested to notify users to expect an invite to the platform before invitation. Here’s an example of what the invite email will look like:
    <br />
    <Frame>
