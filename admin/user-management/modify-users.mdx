...
description: Learn all about updating user details and remove users on the Vork platform.
icon: 'user-gear'
---
...
This is the total number of kudos the employee has to spend (it refreshes daily). A user can use kudos for shoutouts, Vork voice, activity log, etc.
